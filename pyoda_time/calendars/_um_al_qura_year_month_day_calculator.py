...
class _UmAlQuraYearMonthDayCalculator(_RegularYearMonthDayCalculator):
    ...
    __AVERAGE_DAYS_PER_10_YEARS: typing.Final[int] = 3544

    # These four members are generated by UmAlQuraYearMonthDayCalculatorTest.GenerateData.
    __COMPUTED_MIN_YEAR: typing.Final[int] = 1318
    __COMPUTED_MAX_YEAR: typing.Final[int] = 1500
    __COMPUTED_DAYS_AT_START_OF_MIN_YEAR: typing.Final[int] = -25448
    __GENERATED_DATA: typing.Final[str] = (
    ...
    __COMPUTED_DAYS_AT_START_OF_YEAR_1: typing.Final[int] = __COMPUTED_DAYS_AT_START_OF_MIN_YEAR + (
        int(((1 - __COMPUTED_MIN_YEAR) / 10.0) * __AVERAGE_DAYS_PER_10_YEARS)
    )

    __MONTH_LENGTHS: typing.ClassVar[dict[int, int]] = dict()
    __YEAR_LENGTHS: typing.ClassVar[dict[int, int]] = dict()
    __YEAR_START_DAYS: typing.ClassVar[dict[int, int]] = dict()
